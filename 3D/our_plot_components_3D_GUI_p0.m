function our_plot_components_3D_GUI_p0(YrA,A,C,b,f,Cn,options)
...
if plot_df
    ...
    [~,F0] = detrend_df_f_new_no_noise(A,b,C,f,Y_r-C,options);
else
...
% For R2014a and earlier: set(f,'Visible','on');
    ...
    function plot_component(i)
        ...
        subplot(3,3,[3,6,9]);
        if i <= K
            plot(1:T,Y_r(i,:),'linewidth',2); hold all; plot(1:T,C(i,:),'linewidth',2);
            if plot_df
